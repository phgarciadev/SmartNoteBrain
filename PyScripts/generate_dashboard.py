  ...
  <div class="grid-main">
    ...
    <div class="card hero-card grid-left">
      <div class="card-title">
        ...
        <a href="obsidian://command?commandId=obsidian-shellcommands:shell-command-generate_dashboard" class="refresh-btn" onclick="this.classList.add('spinning'); setTimeout(() => window.location.reload(), 5000);" title="Atualizar Dashboard">
