  ...
  <div class="grid-main">
    ...
    <div class="card hero-card grid-left">
      <div class="card-title">
        ...
        <a href="obsidian://shell-commands/?vault=SmartNoteBrain&execute=generate_dashboard" class="refresh-btn" onclick="this.classList.add('spinning'); setTimeout(() => window.location.reload(), 5000);" title="Atualizar Dashboard">
